...
$path = 'http://localhost/SISATIC/images/logo_smul.png';
...
style="position:relative"><span style="left:10px;position:
absolute;left:20px;top:7px;width:56px;height:70px"><img width=56 height=70
src="';

$img2 = 'alt="brasao_prefeitura_pq_pb"></span></span>';

$img = $img1 .$base64 . $img2;

$html1 = '
<span style="font-size:16.0pt;
line-height:115%"> </span><span style="font-size:14.0pt;line-height:115%">PREFEITURA
DO MUNICÍPIO DE SÃO PAULO</span></p>
