...
<body>
  ...
  $totalpcs = $row_pg['totalpcs'];

 /* Conta e imprime o número de switchs na Secretaria */

  $buscar_cadastros = "SELECT COUNT(iditem) AS totalswitch FROM item WHERE tipo = 'SWITCH';";
  $query_cadastros = mysqli_query($conn, $buscar_cadastros);
  $row_pg = mysqli_fetch_assoc($query_cadastros);
  $totalswitch = $row_pg['totalswitch'];
          ...
          <div class="card-body">
            <div class="row no-gutters align-items-center">
              <div class="col mr-2">
                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                  Switchs (Total)</div>
                <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $totalswitch ?></div>
              </div>
              <div class="col-auto">
                <i class="fas fa-calendar fa-2x text-gray-300"></i>
              </div>
      ...
      <div class="col-xl-3 col-md-6 mb-4">
        <div class="card" style="width: 18rem;">
          ...
          <ul class="list-group list-group-flush">
            ...
            <li class="list-group-item">DSIMP: <?php echo $servindsimp ?></li>
            </li>
